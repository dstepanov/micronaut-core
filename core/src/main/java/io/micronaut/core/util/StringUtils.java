...
public final class StringUtils {
    ...
    public static Iterable<CharSequence> splitOmitEmptyStrings(final CharSequence sequence, final char splitCharacter) {
        Objects.requireNonNull(sequence);
        return () -> new SplitIterator(sequence, splitCharacter);
    }

    public static Iterator<CharSequence> splitOmitEmptyStringsIterator(final CharSequence sequence, final char splitCharacter) {
        Objects.requireNonNull(sequence);
        return new SplitIterator(sequence, splitCharacter);
    }

    private static final class SplitIterator implements Iterator<CharSequence> {
        ...
        private SplitIterator(CharSequence sequence, char splitCharacter) {
