...
public class RecoveryInterceptor implements MethodInterceptor<Object, Object> {
    ...
    public Object intercept(MethodInvocationContext<Object, Object> context) {
        ...
        return new ReactiveMethodInterceptorHelper(context) {
            ...
            protected CompletionStage<Object> interceptCompletionStage(CompletionStage<Object> result) {
                return fallbackForFuture(context, result);
            }

            @Override
            protected Publisher<Object> interceptPublisher(Publisher<Object> publisher) {
                return fallbackForReactiveType(context, publisher);
            }
    ...
    private Publisher<Object> fallbackForReactiveType(MethodInvocationContext<Object, Object> context, Publisher<Object> publisher) {
    ...
    @SuppressWarnings("unchecked")
    private CompletionStage<Object> fallbackForFuture(MethodInvocationContext<Object, Object> context, CompletionStage<Object> result) {
